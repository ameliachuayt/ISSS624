...
Since the definition of neighbours changed, we observe difference between the above chart and the one from the previous section.
...
Tin Seong Kam. "4 Global and Local Measures of Spatial Autocorrelation" From [**R for Geospatial Data Science and Analytics**](https://r4gdsa.netlify.app/)https://r4gdsa.netlify.app/chap04.html#mapping-gi-values-with-adaptive-distance-weights
