...
![States of Nigeria[^15]](https://media.springernature.com/lw685/springer-static/image/art%253A10.1186%252Fs12879-021-05894-2/MediaObjects/12879_2021_5894_Fig1_HTML.png){fig-align="center" width="416"}
...
nigeria.gi_sig_f <- cbind(nigeria, as.matrix(gi.adaptive_func)) %>%
  rename(gstat_adaptive = as.matrix.gi.adaptive_func.) %>%
  filter(gstat_adaptive > 3.289 | gstat_adaptive < -3.289 )
...
The Gi statistics have revealed significant pockets of hot (red shades) and cold (blue shades) spot areas. Right away, we observe that these areas are situation on the northern regions. There is larger areas of hot spots and smaller areas of cold spots. The identification of hot and cold spots are less sparse than what we saw in the LISA map.

The cold spots in the top right area includes Bama, Dikwa, Mafa and Ngala. This means that these areas have lower percentage of functional water points. Towards the bottom of the map, we can see more cold spots which includes Orsu, Oji River and Nnewi North.
...
On the top right area, we can see a cold spot. It includes Bama, Dikwa, Mafa and Monguno with more intense clustering (darker shade of blue) and Konduga and Damboa with less intense clustering (lighter shade of blue). The darker blue areas are further towards the outer areas. The area beyond the dark blue shaded region are LGAs without water points at all (no data recorded). This may signify the importance of these water points and probably and importance to ensure they are all functional. The lower percentage of non-functional water points could also be because of the lower number of water points in the area, which increase the importance of existing water points. Towards the left, we have Gumel and Maigatari, Miga and Jahun that are also cold spots.

Looking at the hot spots, we see a relatively large hot spot areas at the bottom right of the map. At the coastal border, we have more intense clustering (dark red), suggesting higher number of non-functional water points in that area. Towards the mainland, the clustering is less intense but with pockets of dark reds.

Moving along the border, towards the left, we can see more hot spots, starting with Southern Ijaw and moving in a C shape pattern upwards towards the central area of Nigeria to Bassa (Kogi State) and Aguatu. Bassa (Kogi State) has the Niger River to its western border and Benue River to its northern border[^18]. Given its location, it may be prone to floods. In fact, the Kogi state is quite flood-prone--see reports of floods in recent years over [here](https://www.thisdaylive.com/index.php/2022/10/11/anambra-kogi-residents-farmers-count-losses-to-massive-floods/) and [here](https://www.pulse.ng/news/local/150-kogi-communities-submerged-in-flood-water/e6fq1wm). It's geographical location may make Bassa an interesting location for future investigative works to enhance water stability through infrastructural changes.

[^18]: https://mapcarta.com/27805612

We also notice some isolated hot and cold spots like Bagudo (top left of map) Igbo-Etiti (below the Bassa LGA).
